...
import type { ListeningDraftAnswers, ListeningPart } from '../api/types';

import { ListeningAnswerField } from './listening-answer-field';
...
function ListeningTablePreview({ tableJson }: { tableJson: Record<string, unknown> | null | undefined }) {
...
export function ListeningSessionQuestionList({
  part,
  activeQuestionId,
  answers,
  questionRefs,
          ...
          <Stack spacing={0.75}>
            ...
            {block.tableJson ? (
              ...
              >
                ...
                <ListeningTablePreview tableJson={block.tableJson} />
              </Box>
            ) : null}
